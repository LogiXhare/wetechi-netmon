...
**Planned for:** Phase 4 (see [../../docs/roadmap.md](../../docs/roadmap.md)).

Static threshold detection, later statistical baselines. See docs/functional-requirements.md (FR-4).
