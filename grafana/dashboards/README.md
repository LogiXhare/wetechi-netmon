...
**Planned for:** Phase 6 (see [../../docs/roadmap.md](../../docs/roadmap.md)).

Original Grafana dashboard JSON (not derived from any proprietary product). See docs/clean-room-boundary.md.
