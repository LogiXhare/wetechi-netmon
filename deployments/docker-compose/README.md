...
**Planned for:** Phase 2 onward, incremental (see [../../docs/roadmap.md](../../docs/roadmap.md)).

Local/dev/reference Docker Compose stacks. Infra-only services first; app services added as each phase ships.
