...
**Planned for:** Phase 2 onward (see [../../docs/roadmap.md](../../docs/roadmap.md)).

Public REST API and internal gRPC API implementation (axum/tonic candidates — see docs/technology-options.md). Resource surface defined in docs/functional-requirements.md (FR-8).
