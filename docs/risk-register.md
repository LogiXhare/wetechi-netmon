...
| R4 | Flow collector (untrusted UDP input) has a memory-safety or parsing vulnerability exploitable by a crafted packet | M | H | Rust with no unsafe without review, mandatory fuzzing before Phase 2 exit, malformed-packet test suite |
