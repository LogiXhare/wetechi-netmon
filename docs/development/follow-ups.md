...
| FU-43 | Phase 5B-0's repository/unit-of-work seam extraction is a refactor of code two Opus 5 adversarial reviews already certified (0 Blocker, 0 High as of the PR #16 merge) | Milestone 5B-0 | Extracting a trait from `IncidentUnitOfWork`'s 72 direct storage accesses, and moving the FU-38 guard hardening into the same pass, is real surgery on recently-certified code — see [ADR 0029](../architecture/decisions/0029-phase5b-repository-and-unit-of-work-seam.md) and **R20** in [risk-register.md](../risk-register.md). **Acceptance gate:** all 531 existing Phase 5A tests remain green throughout 5B-0, proving the refactor changed no behavior, before 5B-1 begins. |
