...
| Incident creation (race) | Read Committed | Target-specific partial unique index (§ ADR 0032's schema; e.g. `incidents_active_host`) | `23505` | 3 | Retry into the update/link path, per [incident-persistence.md](../incident-persistence.md) |
